...
public class SerialNumberUtil {
    ...
    public static Map<String, String> snVo = new HashMap<String, String>();
    ...
    public static Map<String, String> getAllSn(){
        ...
        try {
            ...
            snVo.put("ip",address.getHostAddress());//获取IP地址
            System.out.println("IP  SN:" + address.getHostAddress());
